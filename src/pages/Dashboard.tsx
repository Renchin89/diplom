...
const MainPage: FunctionComponent<Props> = ({ className }) => {
  ...
  return (
    <div className={cn(className, "flex flex-col w-full")}>
      <div className="header flex space-x-10 align-middle items-center w-full">
        <h1 className="text-3xl font-bold w-3/4">32 Employees</h1>
        <p>0 selected</p>
        <div>
          <svg
            width="4"
      ...
      <div className="body grid grid-cols-4 gap-8 mt-10">
        <div className="per-person bg-white p-2">
          ...
          <div className="profile flex flex-col text-center items-center">
            <Avatar className="w-32 h-32 text-5xl mb-4" alt="Remy Sharp" src="/static/images/avatar/1.jpg" />
            <h2>Renchindorj</h2>
            <p>Web developer</p>
          </div>
